...
![](https://upload.wikimedia.org/wikipedia/commons/c/cb/Hawala.png){width=50%}
...
<head>
<style>
  /* Add CSS style for the element that requires a scrollbar */
  .scroll-box {
    width: 800px;
    height: 600px;
    overflow: scroll; /* or "auto" if you want the scrollbar to appear only when needed */
    padding: 10px;
  }
</style>
</head>
